...
export const DEFAULT_TEXTS: readonly TextDefault[] = [
  // ───────────── Безопасность и границы (решения владельца 2026-09-18) ─────────────
  // Эти четыре текста появились после критика полноты: в программе про сон и тревогу
  // нельзя не сказать, что это не лечение, нельзя молча принять сообщение о том, что
  // человеку очень плохо, и нельзя обещать на лендинге удаление истории без команды.
  {
    key: 'onb.disclaimer',
    value:
      'Это практики для самоподдержки. Они не лечат и не заменяют врача или психотерапевта. Если тяжело дольше нескольких недель — стоит поговорить со специалистом.',
    placeholders: [],
    section: 'onboarding',
    hint: 'Приходит сразу за приветствием, один раз. Убирать не стоит: программа про сон и тревогу.',
  },
  {
    key: 'ev.safety',
    value: 'Слушай дома, лёжа или сидя. Не за рулём и не там, где нужно внимание.',
    placeholders: [],
    section: 'evening',
    hint: 'Добавляется к подписи ПЕРВОЙ практики. Дальше не повторяется, чтобы не надоедать.',
  },
  {
    key: 'free.crisis',
    value:
      'Я тебя слышу, и это звучит тяжело. Если сейчас правда очень плохо — это важнее любой практики. Пожалуйста, не оставайся с этим один на один: напиши тому, кому доверяешь, или обратись за помощью сегодня. Я передала твоё сообщение.',
    placeholders: [],
    section: 'onboarding',
    hint:
      'Ответ на сообщение с признаками кризиса. Сюда стоит вписать конкретный контакт помощи — ' +
      'разработчик его не придумывает, это решение специалиста.',
  },
  {
    key: 'del.ask',
    value:
      'Сотру всё, что у меня про тебя есть: удобный час, номер вечера и все цифры. Отменить это будет нельзя. Точно?',
    placeholders: [],
    section: 'onboarding',
    hint: 'Подтверждение команды /delete. Лендинг обещает, что историю можно удалить.',
  },
  {
    key: 'del.done',
    value: 'Стёрла. Ничего про тебя у меня не осталось. Если захочешь начать заново — напиши /start.',
    placeholders: [],
    section: 'onboarding',
    hint: 'После удаления.',
  },
  {
    key: 'del.no',
    value: 'Хорошо, ничего не трогаю.',
    placeholders: [],
    section: 'onboarding',
    hint: 'Если человек передумал удалять.',
  },
  {
    key: 'btn.delete_yes',
    value: 'Да, стереть',
    placeholders: [],
    section: 'buttons',
    hint: 'Подтверждение удаления истории.',
  },
  {
    key: 'btn.delete_no',
    value: 'Нет',
    placeholders: [],
    section: 'buttons',
    hint: 'Отказ от удаления истории.',
  },
  ...
  },
  {
    ...
    placeholders: ['{quiz_index}', '{quiz_sum}', 'quiz_index'],
    section: 'onboarding',
  ...
  },
  {
    ...
    placeholders: ['{when}', '{time}', 'when', 'time'],
    section: 'onboarding',
  ...
  },
  {
    ...
    placeholders: ['{before}', '{bar}', 'before', 'bar'],
    section: 'evening',
  ...
  },
  {
    ...
    placeholders: ['{category}', '{title}', 'category'],
    section: 'evening',
  ...
  },
  {
    ...
    placeholders: ['{line1}', '{line2}', '{title}', '{n}', 'line1', 'line2'],
    section: 'evening',
  ...
  },
  {
    ...
    placeholders: ['{after}', '{bar}', '{delta}', '{dots}', '{n}', '{time}', 'after', 'bar', 'delta', 'dots', 'n'],
    section: 'evening',
  ...
  },
  {
    ...
    placeholders: ['{before}', '{after}', '{d}', '{деление}', 'before', 'after', 'd'],
    section: 'evening',
  ...
  },
  {
    ...
    placeholders: ['{before}', '{after}', '{d}', '{деление}', 'd'],
    section: 'evening',
  ...
  },
  {
    ...
    placeholders: ['{before}', '{after}', '{d}', 'before', 'after'],
    section: 'evening',
  ...
  },
  {
    ...
    placeholders: ['{line1}', '{line2}', '{title}', 'line1', 'line2'],
    section: 'now',
  ...
  },
  {
    key: 'now.close',
    value: 'Записала: {after} {bar}\n{delta}',
    placeholders: ['{after}', '{bar}', '{delta}', 'after', 'bar', 'delta'],
    section: 'now',
  ...
  },
  {
    ...
    placeholders: ['{n}', '{when}', '{time}', 'n', 'when', 'time'],
    section: 'pause',
  ...
  },
  {
    ...
    placeholders: ['{n}', '{when}', '{time}', '{dots}', 'n', 'when', 'time'],
    section: 'pause',
  ...
  },
  {
    ...
    placeholders: ['{time}', '{when}', 'time', 'when'],
    section: 'pause',
    hint: 'Время изменено.',
  },
  ...
  },
  {
    ...
    placeholders: ['{first_before}', '{last_after}', 'first_before', 'last_after'],
    section: 'final',
  ...
  },
  {
    ...
    placeholders: ['{first_before}', 'first_before'],
    section: 'final',
  ...
  { key: 'btn.better_at', value: 'Лучше в {time}', placeholders: ['{time}', 'time'], section: 'buttons',
  ...
  // ─────────── Уведомления владельцу и служебные ответы (Приложение А) ───────────
  {
    ...
    placeholders: ['{id}', '{time}', '{tz}', 'id', 'time', 'tz'],
    section: 'admin',
  ...
  },
  {
    ...
    placeholders: ['{id}', '{first_before}', '{last_after}', '{avg}', 'id', 'first_before', 'last_after', 'avg'],
    section: 'admin',
  ...
  },
  {
    ...
    placeholders: ['{id}', '{text}', '{n}', 'id', 'text'],
    section: 'admin',
  ...
  },
  {
    ...
    placeholders: ['{id}', '{tg_id}', 'tg_id', 'id'],
    section: 'admin',
  ...
  // ───────── Тест «Индекс внутренней опоры» (quiz-spec.md, дословно) ─────────
  {
    ...
    placeholders: ['{quiz_index}', 'quiz_index'],
    section: 'quiz',
  ...
  },
  {
    key: 'quiz.question',
    value: '{k} / 7\n\n{text}\n\n0 — {low}\n10 — {high}',
    placeholders: ['{k}', '{text}', '{low}', '{high}', 'k', 'text', 'low', 'high'],
    section: 'quiz',
  ...
  },
  {
    ...
    placeholders: ['{quiz_index}', '{quiz_index_after}', 'quiz_index', 'quiz_index_after'],
    section: 'quiz',
