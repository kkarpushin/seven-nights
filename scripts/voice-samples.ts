 ...
 * Слушать: http://100.91.124.2:3700/samples (сервис отдаёт эту папку) или открыть файл локально.
 *
...
const CANDIDATES: Array<{ id: string; label: string; note: string; v: VoiceParams }> = [
  {
    ...
    note: 'Генеративный голос нового поколения — самый живой и тёплый. Не поддаётся замедлению и не уважает теги пауз, но паузы мы всё равно делаем склейкой.',
    v: { voice: 'ru-RU-Masha:MAI-Voice-2', style: 'caringempathy', rate: '-15%' },
  },
  {
    id: 'masha-hd-reflective',
    label: 'Маша (HD), стиль «размышление»',
    note: 'Тот же голос, более отстранённая подача. Вариант, если «забота» покажется слишком мягкой.',
    v: { voice: 'ru-RU-Masha:MAI-Voice-2', style: 'reflective', rate: '-15%' },
  },
  {
    id: 'svetlana',
    label: 'Светлана',
    note: 'Классический голос: ровный, предсказуемый, темп ровно медитативный (примерно сто слов в минуту). Слушается спокойно, но менее «живой».',
    v: { voice: 'ru-RU-SvetlanaNeural', rate: '-15%' },
  },
  {
    id: 'dariya',
    label: 'Дарья',
    note: 'Мягче Светланы, чуть выше тембр.',
    v: { voice: 'ru-RU-DariyaNeural', rate: '-15%' },
  },
  {
    id: 'masha-flash-caring',
    label: 'Маша (Flash), стиль «забота»',
    note: 'Быстрая версия генеративного голоса — запасной вариант.',
