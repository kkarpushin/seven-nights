 ...
 * Слушать: превью-сервер на :3701 (`scripts/preview-server.ts`), боевой сервис на :3700
 * по адресу /samples, или просто открыть content/audio/samples/index.html в браузере.
 *
